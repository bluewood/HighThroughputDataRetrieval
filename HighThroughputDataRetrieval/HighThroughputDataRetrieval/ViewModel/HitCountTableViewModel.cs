...
namespace HighThroughputDataRetrieval.ViewModel
{
    public class HitCountTableViewModel
    {
        ...
        private readonly string _organism; // For now, we only accept single organism
        private readonly string _keyword;  // For now, we only accept single keyword
        #endregion // Fields

        #region Properties
        public IEnumerable<string> ProteinList
        {
            get { return _proteinList; }
        }
